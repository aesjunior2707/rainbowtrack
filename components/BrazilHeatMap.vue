  ...
  <div class="w-full">
    <div class="card p-6">
      <h2 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
        ...
        Capturas por Estado - Inteligência Competitiva
      </h2>
          ...
          <div class="bg-gradient-to-r from-primary-500 to-primary-600 text-white p-4 rounded-xl shadow-md">
            <div class="flex items-center justify-between">
              <div>
                ...
                <div class="text-primary-100 text-sm">Total de Capturas</div>
              </div>
          ...
          <div class="bg-gradient-to-r from-purple-500 to-purple-600 text-white p-4 rounded-xl shadow-md">
            <div class="flex items-center justify-between">
              <div>
                ...
                <div class="text-purple-100 text-sm">Média por Estado</div>
              </div>
              <div class="bg-white bg-opacity-20 p-3 rounded-lg">
